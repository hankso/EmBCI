...
# coding=utf-8
#
# File: MotorImagery/__init__.py
# Authors: Hank <hankso1106@gmail.com>
# Create: 2019-02-19 01:12:50
...
# CSP each with dimensionality (#of trials of task N) x (feature vector).
...
def CommonSpatialPattern(*tasks):
    '''
    Common Spatial Pattern implementation in Python, used to build spatial
    filters for identifying task-related activity.
    '''
    if len(tasks) < 2:
    ...
    filters = ()
    # CSP algorithm
    # For each task x, find the mean variances Rx and not_Rx,
    # which will be used to compute spatial filter SFx
...
# covarianceMatrix takes a matrix A and returns the covariance matrix,
...
def spatialFilter(Ra, Rb):
    ...
    # CSP requires the eigenvalues E and eigenvector U be sorted in descending
    # order
    ord = np.argsort(E)
